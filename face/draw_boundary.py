...
# -*- coding: utf-8 -*-
import cv2
def draw_boundary(ret , img, classifier, scaleFactor, minNeighbors, color, clf):
    print('draw_boundary')
    if ret:
...
def detect_face(ret ,img, faceCascade, img_id, clf):
    print('detect_face')
    img, coords = draw_boundary(ret , img, faceCascade, 1.1, 10, (0, 0, 255), clf)
